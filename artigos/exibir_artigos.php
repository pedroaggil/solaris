...
<body>
              ...
              <ul class="dropdown-menu">
                <?php 
                  ...
                  if (isset($_SESSION['id'])) {
                      ?><li><a class="dropdown-item" href="../php/logout.php">Sair</a></li><?php
                  } else {
                      ?><li><a class="dropdown-item" href="../login/index.html">Entrar</a></li><?php
                  }
  ...
  <!-- título-->
    ...
    <form method="post" action>
        <select name="filtro">
          <option value="a">Busque por...</option> 
          ...
          <option value="a">limpar filtro</option> 
        </select>
...
}else{ $search =  "SELECT * FROM tb_artigos";
